...
namespace Test_Tiss.Models
{
    ...
    public partial class TISS_WebEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetArticleClickReport_Result> GetArticleClickReport()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetArticleClickReport_Result>("GetArticleClickReport");
        }
    }
}
