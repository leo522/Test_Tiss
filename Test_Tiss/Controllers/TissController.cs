...
using static Test_Tiss.Models.ArticleModel;
...
namespace Test_Tiss.Controllers
{
    public class TissController : Controller
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult GenderEquality(int page = 1, int pageSize = 5)
        {
            Session["ReturnUrl"] = Request.Url.ToString();
